...
from watchlist_app.serializers import WatchlistSerializer,StreamPlateformSerializer,ReviewSerializer


# Search User review by Username
...
class StreamPlateformView(viewsets.ModelViewSet):
    queryset=StreamPlateform.objects.all().order_by('-id')
